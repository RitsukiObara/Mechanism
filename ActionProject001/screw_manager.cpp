//============================================
//
// 起伏マネージャー処理[out_ball_manager.cpp]
// Author：小原立暉
//
//============================================
//********************************************
...
// 静的メンバ変数宣言
//--------------------------------------------
CScrewManager* CScrewManager::m_pManager = nullptr;			// プレイヤーの変数
...
void CScrewManager::Regist(CScrew* pThis)
{
	...
	{ // 上記以外
		...
		// ローカルポインタを宣言
		CScrew* pObject = m_pTop;			// 先頭のオブジェクト
...
{
	// ローカル変数宣言
	CScrew* pObj = nullptr;		// 現在のオブジェクトのポインタ
