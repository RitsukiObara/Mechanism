...
// 静的メンバ変数宣言
//--------------------------------------------
CEnemyManager* CEnemyManager::m_pManager = nullptr;			// マネージャーの変数
...
// 登録処理
//============================
void CEnemyManager::Regist(CEnemy* pThis)
{
	if (m_pTop == nullptr)
	{ // オブジェクトが NULL の場合
	...
	{ // 上記以外
		...
		// ローカルポインタを宣言
		CEnemy* pObject = m_pTop;			// 先頭のオブジェクト
...
{
	// ローカル変数宣言
	CEnemy* pObj = nullptr;		// 現在のオブジェクトのポインタ
...
// オブジェクトの取得処理
//===========================================
CEnemy* CEnemyManager::GetTop(void)
{
	// オブジェクトの情報を渡す
	return m_pTop;
}
...
// リスト構造の引き抜き処理
//===========================================
void CEnemyManager::Pull(CEnemy* pThis)
{
	// ローカル変数宣言
	CEnemy* pObj = nullptr;		// 現在のオブジェクトのポインタ
...
// 取得処理
//============================
CEnemyManager* CEnemyManager::Get(void)
{
	// マネージャーのポインタを返す
	return m_pManager;
}